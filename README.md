...
# Ai Voice Agent Teacher

This repository contains AI Voice Agent Teacher, built using the VideoSDK Agents architecture with a cascading pipeline.

## Description

This AI Voice Agent is designed to act as a helpful assistant for AI Voice Agent Teacher. It can answer questions and perform tasks related to this domain.
...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/poojan-live/ai-voice-agent-teacher.git
   ```

2. **Navigate to the project directory:**
   ```bash
   cd ai-voice-agent-teacher
   ```
